package com.police.modle.dao.impl.utils;
...
public class UserCloumToBean implements ResultTransformer {
	private static final Log logger = LogFactory.getLog(UserCloumToBean.class);
	private static final long serialVersionUID = 1L;
	private Class<?> resultClass;
	private Setter[] setters;
	private PropertyAccessor propertyAccessor;

	public UserCloumToBean(Class<?> resultClass) {
		if (resultClass == null)
